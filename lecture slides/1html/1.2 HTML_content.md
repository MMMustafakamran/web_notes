...
Basic Construction of an HTML Page: HTML now elements: Email clemont Date clemont Number clement Color elcment Ii ensutes Ihal Wser The dale elemenl: Ii ensufes Ihal user enlers II lacililales Ihe user [o enlers & valld emall Ii shows J calemdar (0 Wser omly & mumeric vale choose & ccior address lo selecl & dale <inpul lype="mumber" <impul Iype-"colar" <Input lype="emall" <Inpul Iype="dale name="mumdem > name="coldi mame-"emall > mame="DoB >
