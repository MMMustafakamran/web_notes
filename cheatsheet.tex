...
\lstset{
    ...
    basicstyle=\ttfamily\tiny, % Changed from scriptsize to tiny for more space
    commentstyle=\color{codegreen}\tiny,
    keywordstyle=\color{codeblue}\tiny,
    stringstyle=\color{codepurple}\tiny,
    breaklines=true,
    tabsize=2,
    frame=single,
    framerule=0.2pt, % Thinner frame
    xleftmargin=1pt,
    xrightmargin=1pt,
    aboveskip=0pt, % Removed skip
    belowskip=1pt,
